                ...
                <div class="row">
                    <div class="col-12 d-flex">
                        ...
                        <div class="navigation__sections">
                            ...
                            <a href="<?php echo $preUrl ?>/conta">
                                Conta
                            </a>
                            <a href="<?php echo $preUrl ?>/duvidas">
                                Dúvidas
                            </a>
                            <a href="<?php echo $preUrl ?>/esgoto">
                                Esgoto
                            </a>
                        </div>
                        <!-- SOCIAL -->
                        <div class="navigation__social">
                            <a class="navigation__social__text" href="<?php echo $preUrl ?>/">
                                Login
                            </a>
                            <a class="navigation__social__icon" target="_blank" href="https://www.facebook.com/copasaoficial"><svg
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 264 512">
                                    <path
                                        d="M76.7 512V283H0v-91h76.7v-71.7C76.7 42.4 124.3 0 193.8 0c33.3 0 61.9 2.5 70.2 3.6V85h-48.2c-37.8 0-45.1 18-45.1 44.3V192H256l-11.7 91h-73.6v229" />
                                </svg>
                            </a>
                            <a class="navigation__social__icon"  target="_blank" href="https://www.instagram.com/copasamg/"><svg
                            ...
                            <a class="navigation__social__icon" target="_blank" href="https://twitter.com/copasamg"><svg
                            ...
                            <a class="navigation__social__icon" target="_blank" href="https://twitter.com/copasamg">
