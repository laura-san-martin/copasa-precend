...
$conteudoParaquemFile = file_get_contents($_SERVER['DOCUMENT_ROOT'].$preUrl."/public/static/praquem.json");
$conteudoParaquem = json_decode($conteudoParaquemFile, true);
...
<section class="copasa__texto">
    <div class="container">
        <div class="row">
            <?php foreach($conteudoParaquem as $conteudo): ?>
                <div class="col-12">
